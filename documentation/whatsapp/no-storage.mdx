...
![](https://scontent-fra5-1.xx.fbcdn.net/v/t39.2365-6/559308894_1116451836859295_8169970485040161301_n.png?_nc_cat=102&ccb=1-7&_nc_sid=e280be&_nc_ohc=k1uGl8woJpsQ7kNvwHnj1dp&_nc_oc=AdnGUYpkKnF3RfytaUsSuKTZhxmR28QUYLoUiG8KiKA2HotA47-2-EXJSy4Q-OLEb84&_nc_zt=14&_nc_ht=scontent-fra5-1.xx&_nc_gid=zu2UgrN4IXd_SobOvIHicQ&oh=00_Afkq4aoc5Dgh51C2eBMNfkco2Z2KG_W5zALwuyKb5M6pAw&oe=69552255)
...
Enabling the feature is done before registration by calling the [POST /&lt;BUSINESS_PHONE_NUMBER_ID&gt;/settings](https://developers.facebook.com/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/settings-api#Updating) endpoint.
...
Enabling the feature is done within the [POST /&lt;BUSINESS_PHONE_NUMBER_ID&gt;/register](https://developers.facebook.com/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/register-api#Creating) registration request.
...
To disable No Storage, you must de-register the bsuiness phone number using the [POST /&lt;WHATSAPP_BUSINESS_PHONE_NUMBER_ID&gt;/deregister](https://developers.facebook.com/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/phone-number-deregister-api#Creating) endpoint, then register the number again without the `meta_store_retention_minutes` parameter.
