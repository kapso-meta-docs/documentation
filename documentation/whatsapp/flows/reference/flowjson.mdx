...
Managed by the business. Learn more [Learn more](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson)
...
[Choose insurance type](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson)
...
Terminates the flow and sends the response message to the chat thread. The business will receive the termination message bubble on the webhook, together with the flow_token and all of the other parameters from the payload. More information can be found [here](https://developers.facebook.com/docs/whatsapp/flows/gettingstarted/receiveflowresponse).
...
[Flow JSON](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#flow-json)

[Introduction](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#introduction)

[Top-level Flow JSON Properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#top-level-flow-json-properties)

[Screens](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#screens)

[Required properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#required-properties)

[Optional properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#optional-properties)

[Additional information on refresh_on_back](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#additional-information-on-refresh-on-back)

[Additional information on sensitive fields](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#additional-information-on-sensitive-fields)

[Layout](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#layout)

[Routing Model](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#routing-model)

[When to define routes](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#when-to-define-routes)

[How to define routes](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#how-to-define-routes)

[Routing rules](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#routing-rules)

[Properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#properties)

[Static properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#static-properties)

[Dynamic properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#dynamic-properties)

[Nested Expressions](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#nested_expressions)

[Declaring screen properties (No endpoint example)](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#declaring-screen-properties--no-endpoint-example-)

[Declaring screen properties (Endpoint powered example)](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#declaring-screen-properties--endpoint-powered-example-)

[Forms and Form properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#forms-and-form-properties)

[Using Form properties](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#using-form-properties)

[Building forms guidelines](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#building-forms-guidelines)

[Form configuration](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#form-configuration)

[Actions](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#actions)

[navigate action](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#navigate-action)

[complete action](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#complete-action)

[Example of flow using navigate and complete actions](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#example-of-flow-using-navigate-and-complete-actions)

[data_exchange action](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#data-exchange-action)

[update_data action](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#update-data-action)

[Examples](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#examples)

[open_url action](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#open-url-action)

[Components](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#components)

[Static Validation Errors](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#static-validation-errors)

[Limitations](https://developers.facebook.com/docs/whatsapp/flows/reference/flowjson#limitations)