...
**Next states**: [Deleted](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deleted), [Published](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#published)
...
- In case you need to change the flow significantly, please consider [creating a new Flow](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#create) that clones the existing one (using the `clone_flow_id` field).
- Since you cannot delete published flow, deprecate it instead using [the `/deprecate` API call](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#deprecate).

**Next states**: [Draft](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#draft), [Deprecated](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deprecated), [Throttled](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#throttled)
...
If WhatsApp monitoring detects an improvement in the health of the Flow's endpoint, the Flow will be transitioned out of the Throttled state and back into the [Published](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#published) state.

**Next states**: [Published](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#published), [Deprecated](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deprecated), [Blocked](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#blocked)

### Blocked

If a Flow has entered the [Throttled](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#throttled) state and WhatsApp monitoring detects that the health of the provided endpoint has deteriorated even further, the Flow will be transitioned into the Blocked state. This is to prevent a degraded user experience for WhatsApp Flows.

While in the Blocked state, the Flow cannot be sent by the business and cannot be opened by users. WhatsApp monitoring will continue to check the health of the endpoint, and upon improvement the Flow will be transitioned back to [Throttled](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#throttled) and then to [Published](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#published) state.

**Next states**: [Deprecated](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deprecated), [Throttled](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#throttled)
...
| --- | --- | --- | --- |
|  | Create a new Flow | [Create](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#create) | Draft |
| Draft | Update the Flow JSON content | [Update JSON](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update-json) | Draft |
| Draft | Update the `data_channel_uri` | [Update](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update) | Draft |
| Draft | Decide that the Flow is ready for production | [Publish](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#publish) | Published |
...
| Draft | Update the Flow JSON content | [Update JSON](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update-json) | Draft |
| Draft | Update the `data_channel_uri` | [Update](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#update) | Draft |
| Draft | Decide that the Flow isn't needed anymore | [Delete](https://developers.facebook.com/docs/whatsapp/flows/reference/flowsapi#delete) | Deleted |

[←\\
\\
Previous\\
\\
What are Flows?](https://developers.facebook.com/docs/whatsapp/flows/introduction/whatarewaflows)

[→\\
\\
Next\\
\\
Introduction to Flow JSON](https://developers.facebook.com/docs/whatsapp/flows/introduction/introflowjson)

On This Page

[Lifecycle of a Flow](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#lifecycle-of-a-flow)

[Business-set Flow states](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#business-set-flow-states)

[Draft](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#draft)

[Deleted](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deleted)

[Published](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#published)

[Deprecated](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#deprecated)

[System-set Flow States](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#system-set-flow-states)

[Throttled](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#throttled)

[Blocked](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#blocked)

[Editing published flow](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#editing-a-published-flow)

[Example Flow Lifecycles](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#example-flow-lifecycles)

[A successful Flow](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#a-successful-flow)

[A Flow with health issues](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#a-flow-with-health-issues)

[A Flow that never makes it to production](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle#a-flow-that-never-makes-it-to-production)