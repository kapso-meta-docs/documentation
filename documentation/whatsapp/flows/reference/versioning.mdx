...
Adapting the guidance provided by Semantic Versioning (see [semver.org](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#)), version numbers adhere to the following rules:
...
[Versioning](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#versioning)

[Overview](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#overview)

[Version Formats](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#version-formats)

[Major versus minor versions](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#major-versus-minor-versions)

[Early Release Versions](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#early-release-versions)

[Version support and lifecycle](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#version-support-and-lifecycle)

[States](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#states)

[Target support schedule](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#target-support-schedule)

[Examples](https://developers.facebook.com/docs/whatsapp/flows/reference/versioning#examples)