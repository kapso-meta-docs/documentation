...
This guide explains how to set up [WhatsApp Business Calling API](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling) using SIP signaling with [Asterisk](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.asterisk.org%2F&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), an open-source PBX (Private Branch Exchange). You’ll learn how to configure your Asterisk server, connect SIP phones, and handle both incoming and outgoing WhatsApp calls.
...
WA - Asterisk leg will be using SDES for media encryption key exchange and opus for audio codec

Asterisk - Sip UA will be using SDES for media encryption key exchange and opus or G711 for audio codec

### Prerequisites

Asterisk Deployment: Asterisk is deployed (ex: on a public cloud instance)
Operating System: Any OS compatible for Asterisk. Ex: CentOS 9
...
incoming_welcome: incoming_welcome.wav (not provided) place this file under /var/lib/asterisk/sounds
outgoing_welcome: outgoing_welcome.wav (not provided) place this file under /var/lib/asterisk/sounds
...
Download and install a softphone client (ex: [Linphone](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.linphone.org%2Fen%2Fdownload&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA)) for testing both business-initiated and user-initiated calls.
...
SIP Address: e.g., sip:1001@{asterisk-sip-server-dns}
SIP Server Address: e.g., sip:{asterisk-sip-server-dns};transport=tls
Transport: TLS
Disable ICE
Enable AVPF
Disable “Publish presence information”
Confirm and save the account.
Enter the password when prompted (viz. {sip-ua-password})
...
Confirm that the SIP URL is correct and the domain is pointing to the Asterisk server. Run host {domain-name} to verify that the ip address is pointing to the Asterisk server

#### Not receiving ACK from Meta
...
This guide explains how to set up [WhatsApp Business Calling API](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling) using SIP signaling with [FreeSWITCH](https://l.facebook.com/l.php?u=https%3A%2F%2Fsignalwire.com%2Ffreeswitch&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), an open-source communication framework. You’ll learn how to configure your FreeSWITCH server, connect SIP phones, and handle both user-initiated and business-initiated WhatsApp calls.
...
WA - FreeSWITCH leg uses SDES for media encryption key exchange with Opus as the audio code. FreeSWITCH - SIP UA leg uses SDES for media encryption key exchange with Opus or G.711 audio codecs

### Prerequisites

FreeSWITCH Deployment: FreeSWITCH is deployed (ex: on a public cloud instance)
Operating System: Any OS compatible with FreeSWITCH. Ex: CentOS 9
...
<include>
 <extension name="c2b_calls_sip_ivr">
   ...
   <condition field="${sip_from_host}" expression="^wa.meta.vc$">
     <!--Verify the ip from where the request is coming, compare the ip with the Meta white listed ip's-->
...
Confirm that the SIP URL is correct and the domain is pointing to the Freeswitch server. Run host {domain-name} to verify that the ip address is pointing to the Freeswitch server
...
This guide explains how to set up [WhatsApp Business Calling API](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling) using [WhatsApp Cloud API signaling](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling/business-initiated-calls) with [FreeSWITCH](https://l.facebook.com/l.php?u=https%3A%2F%2Fsignalwire.com%2Ffreeswitch&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), an open-source communication framework and [Janus](https://l.facebook.com/l.php?u=https%3A%2F%2Fjanus.conf.meetecho.com%2F&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), a general purpose WebRTC server. You’ll learn how to configure your FreeSWITCH server, connect SIP phones, and handle both incoming and outgoing WhatsApp calls.

![](https://scontent-fra5-2.xx.fbcdn.net/v/t39.2365-6/572080785_1362494772245673_6325189235439218390_n.png?_nc_cat=106&ccb=1-7&_nc_sid=e280be&_nc_ohc=kfw_2uqqNa8Q7kNvwF0cGWJ&_nc_oc=Adn5RZO3xjPgu131UaAvVE_FQcL0B4JEtxC2i0OnosGEwNxUJ85gSsVTDuDqy2PjAm4&_nc_zt=14&_nc_ht=scontent-fra5-2.xx&_nc_gid=SJWwGMKax_DEvg_1tzBU_g&oh=00_AfmXcdTi_udbh_9vx9MF8t6FX8AnXglb6P1-CAE-Lq1yvQ&oe=69552031)
...
Janus server sits between WA and FreeSWITCH and will convert media from WA (WebRTC complaint with DTLS key exchange) to FreeSWITCH negotiated media (SDES key exchange)
...
An implementation of [Janus SIP plugin](https://l.facebook.com/l.php?u=https%3A%2F%2Fjanus.conf.meetecho.com%2Fdocs%2Fsip&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA) to connect to Janus. The Janus plugin implementation will connect to FreeSWITCH using extension 1000 which is reserved for bridging
...
When the the Janus SIP plugin receives the SIP 200 OK, a Graph API accept call request is sent to Meta to accept the incoming call by passing the SDP received as part of SIP answer

### Building and Installing Janus

Refer to [https://github.com/meetecho/janus-gateway](https://l.facebook.com/l.php?u=https%3A%2F%2Fgithub.com%2Fmeetecho%2Fjanus-gateway&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA)
...
<include>
 <extension name="c2b_calls_ivr">
   <condition field="destination_number" expression="^c2b-sip$">
     ...
     <!--While the call is being bridged, play a ringtone for the caller-->
     <action application="set" data="ringback=%(2000, 4000, 440.0, 480.0)"/>
     <!--WA calls bridged via Janus through extension 1000 only support OPUS. However, the callee might be restricted to other codecs e.g. G722-->
 ...
 <extension name="b2c_calls_ivr">
   <condition field="destination_number" expression="^b2c-sip$">
     ...
     <!--While the call is being bridged, play a ringtone for the caller-->
     <action application="set" data="ringback=%(2000, 4000, 440.0, 480.0)"/>
     <!--WA calls bridged via Janus through extension 1000 only support OPUS. However, the caller might be restricted to other codecs e.g. G722-->
...
This guide explains how to set up [WhatsApp Business Calling API](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling) using [WhatsApp Cloud API signaling](https://developers.facebook.com/documentation/business-messaging/whatsapp/calling/business-initiated-calls) with [Asterisk](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.asterisk.org%2F&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), an open-source PBX (Private Branch Exchange) and [RtpEngine](https://l.facebook.com/l.php?u=https%3A%2F%2Fgithub.com%2Fsipwise%2Frtpengine&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA), an open-source proxy used for relaying, manipulating and controlling RTP streams. You’ll learn how to configure your Asterisk server, connect SIP phones, and handle both incoming and outgoing WhatsApp calls.
...
Operating System: Any OS compatible with Asterisk and RtpEngine. Ex: CentOS 9
...
RtpEngineClient: To control RtpEngine via [ng control protocol](https://l.facebook.com/l.php?u=https%3A%2F%2Frtpengine.readthedocs.io%2Fen%2Flatest%2Fng_control_protocol.html&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA) for bridging media

![Image](https://scontent-fra3-2.xx.fbcdn.net/v/t39.2365-6/588774775_1371828608009123_2185027351279871462_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=e280be&_nc_ohc=6BxR5buIC44Q7kNvwEE3Mq5&_nc_oc=AdkJKLVSPOH1qFeAN9Htppm3TrHsGtSjYjh3ilUMllS4hUeK4Um-3YfUd-rI2o2N8Gw&_nc_zt=14&_nc_ht=scontent-fra3-2.xx&_nc_gid=SJWwGMKax_DEvg_1tzBU_g&oh=00_Afl3Oltw67uzCFSI1X6DI1QzQuqhSe-w_vM5sHxyqNc9mA&oe=695529A1)
...
Refer to [https://github.com/sipwise/rtpengine](https://l.facebook.com/l.php?u=https%3A%2F%2Fgithub.com%2Fsipwise%2Frtpengine&h=AT1GbwqpI0vdOoHQvrjvmLfsqFGE05BYoSpN0TZd2pk80Aeeg6OuJbQXAq5dFmt0gxKvZyT27ruhouMLoztlrsK2m0hcKcg2dmo_wHHaLbb6tlr0OJddLTrFg2UcuXF253sMcBCN2VacNA) to build and install RtpEngine
