...
quality_ratingOne of "GREEN", "YELLOW", "RED", "NA"
...
code_verification_statusOne of "VERIFIED", "UNVERIFIED"
...
name_statusOne of "APPROVED", "AVAILABLE_WITHOUT_REVIEW", "DECLINED", "EXPIRED", "PENDING_REVIEW", "NONE"
...
connection_statusWhatsAppBusinessAccountToNumberStatus
...
show_security_notificationsboolean

Whether to show security notifications

* * *

notify_user_change_numberboolean
...
search_visibilityWAAPIBusinessGlobalSearchStateStatus

Search visibility status for the WhatsApp Business Account

* * *

webhook_configurationWebhookConfiguration
...
override_callback_uristring (uri)·required
